...
public class Elementalists extends JFrame {
...
class PassWordDialog extends JDialog {
    ...
    private final JLabel jlblTitle = new JLabel();
    ...
    public PassWordDialog(final JFrame parent, boolean modal) {
        ...
        p3.add(jlblUsername);
        p3.add(jlblPassword);
        p3.setBackground(new Color(-4149));
        p3.setForeground(new Color(-4149));

        JPanel p4 = new JPanel(new GridLayout(2, 1));
        p4.add(jtfUsername);
        p4.add(jpfPassword);
        p4.setBackground(new Color(-4149));
        p4.setForeground(new Color(-4149));

        JPanel p6 = new JPanel(new BorderLayout());
        Font label1Font = this.$$$getFont$$$("Papyrus", -1, 48, jlblTitle.getFont());
        if (label1Font != null) jlblTitle.setFont(label1Font);
        jlblTitle.setForeground(new Color(-7921800));
        jlblTitle.setText("Elementalists");
        jlblTitle.setHorizontalAlignment(SwingConstants.CENTER);
        p6.setBackground(new Color(-4149));
        p6.setForeground(new Color(-4149));
        p6.add(jlblTitle);

        JPanel p1 = new JPanel();
        p1.setBackground(new Color(-4149));
        p1.setForeground(new Color(-4149));
        p1.add(p6);
        p1.add(p3);
        p1.add(p4);
        ...
        p2.add(jbtOk);
        p2.add(jbtCancel);
        p2.setBackground(new Color(-4149));
        p2.setForeground(new Color(-4149));

        JPanel p5 = new JPanel(new BorderLayout());
        p5.add(p2, BorderLayout.CENTER);
        p5.add(jlblStatus, BorderLayout.NORTH);
        p5.setBackground(new Color(-4149));
        p5.setForeground(new Color(-4149));
        ...
        jbtOk.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (Arrays.equals("pass".toCharArray(), jpfPassword.getPassword())
